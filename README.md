...
but you can add your own. Why did I implement user security if I plan on keeping everything local? for fun . I used Tzapu's WiFiManager extension for internet connection
